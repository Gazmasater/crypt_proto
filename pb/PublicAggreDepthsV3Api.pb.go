...
const file_PublicAggreDepthsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1cPublicAggreDepthsV3Api.proto\x12\x02pb\"\xdc\x01\n" +
	"\x16PublicAggreDepthsV3Api\x121\n" +
	"\x04asks\x18\x01 \x03(\v2\x1d.pb.PublicAggreDepthV3ApiItemR\x04asks\x121\n" +
	"\x04bids\x18\x02 \x03(\v2\x1d.pb.PublicAggreDepthV3ApiItemR\x04bids\x12\x1c\n" +
	...
	"\x1ccom.mxc.push.common.protobufB\x1bPublicAggreDepthsV3ApiProtoH\x01P\x01Z\x0ecrypt_proto/pbb\x06proto3"
...
var file_PublicAggreDepthsV3Api_proto_goTypes = []any{
	(*PublicAggreDepthsV3Api)(nil),    // 0: pb.PublicAggreDepthsV3Api
	(*PublicAggreDepthV3ApiItem)(nil), // 1: pb.PublicAggreDepthV3ApiItem
}
var file_PublicAggreDepthsV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicAggreDepthsV3Api.asks:type_name -> pb.PublicAggreDepthV3ApiItem
	1, // 1: pb.PublicAggreDepthsV3Api.bids:type_name -> pb.PublicAggreDepthV3ApiItem
