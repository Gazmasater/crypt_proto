...
const file_PublicIncreaseDepthsBatchV3Api_proto_rawDesc = "" +
	"\n" +
	"$PublicIncreaseDepthsBatchV3Api.proto\x12\x02pb\x1a\x1fPublicIncreaseDepthsV3Api.proto\"s\n" +
	"\x1ePublicIncreaseDepthsBatchV3Api\x123\n" +
	"\x05items\x18\x01 \x03(\v2\x1d.pb.PublicIncreaseDepthsV3ApiR\x05items\x12\x1c\n" +
	"\teventType\x18\x02 \x01(\tR\teventTypeBW\n" +
	"\x1ccom.mxc.push.common.protobufB#PublicIncreaseDepthsBatchV3ApiProtoH\x01P\x01Z\x0ecrypt_proto/pbb\x06proto3"
...
var file_PublicIncreaseDepthsBatchV3Api_proto_goTypes = []any{
	(*PublicIncreaseDepthsBatchV3Api)(nil), // 0: pb.PublicIncreaseDepthsBatchV3Api
	(*PublicIncreaseDepthsV3Api)(nil),      // 1: pb.PublicIncreaseDepthsV3Api
}
var file_PublicIncreaseDepthsBatchV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicIncreaseDepthsBatchV3Api.items:type_name -> pb.PublicIncreaseDepthsV3Api
