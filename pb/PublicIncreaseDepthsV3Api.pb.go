...
const file_PublicIncreaseDepthsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1fPublicIncreaseDepthsV3Api.proto\x12\x02pb\"\xbf\x01\n" +
	"\x19PublicIncreaseDepthsV3Api\x124\n" +
	"\x04asks\x18\x01 \x03(\v2 .pb.PublicIncreaseDepthV3ApiItemR\x04asks\x124\n" +
	"\x04bids\x18\x02 \x03(\v2 .pb.PublicIncreaseDepthV3ApiItemR\x04bids\x12\x1c\n" +
	...
	"\x1ccom.mxc.push.common.protobufB\x1ePublicIncreaseDepthsV3ApiProtoH\x01P\x01Z\x0ecrypt_proto/pbb\x06proto3"
...
var file_PublicIncreaseDepthsV3Api_proto_goTypes = []any{
	(*PublicIncreaseDepthsV3Api)(nil),    // 0: pb.PublicIncreaseDepthsV3Api
	(*PublicIncreaseDepthV3ApiItem)(nil), // 1: pb.PublicIncreaseDepthV3ApiItem
}
var file_PublicIncreaseDepthsV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicIncreaseDepthsV3Api.asks:type_name -> pb.PublicIncreaseDepthV3ApiItem
	1, // 1: pb.PublicIncreaseDepthsV3Api.bids:type_name -> pb.PublicIncreaseDepthV3ApiItem
