...
const file_PublicBookTickerBatchV3Api_proto_rawDesc = "" +
	"\n" +
	" PublicBookTickerBatchV3Api.proto\x12\x02pb\x1a\x1bPublicBookTickerV3Api.proto\"M\n" +
	"\x1aPublicBookTickerBatchV3Api\x12/\n" +
	"\x05items\x18\x01 \x03(\v2\x19.pb.PublicBookTickerV3ApiR\x05itemsBS\n" +
	"\x1ccom.mxc.push.common.protobufB\x1fPublicBookTickerBatchV3ApiProtoH\x01P\x01Z\x0ecrypt_proto/pbb\x06proto3"
...
var file_PublicBookTickerBatchV3Api_proto_goTypes = []any{
	(*PublicBookTickerBatchV3Api)(nil), // 0: pb.PublicBookTickerBatchV3Api
	(*PublicBookTickerV3Api)(nil),      // 1: pb.PublicBookTickerV3Api
}
var file_PublicBookTickerBatchV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicBookTickerBatchV3Api.items:type_name -> pb.PublicBookTickerV3Api
