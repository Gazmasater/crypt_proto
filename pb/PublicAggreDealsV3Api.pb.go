...
const file_PublicAggreDealsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1bPublicAggreDealsV3Api.proto\x12\x02pb\"j\n" +
	"\x15PublicAggreDealsV3Api\x123\n" +
	"\x05deals\x18\x01 \x03(\v2\x1d.pb.PublicAggreDealsV3ApiItemR\x05deals\x12\x1c\n" +
...
var file_PublicAggreDealsV3Api_proto_goTypes = []any{
	(*PublicAggreDealsV3Api)(nil),     // 0: pb.PublicAggreDealsV3Api
	(*PublicAggreDealsV3ApiItem)(nil), // 1: pb.PublicAggreDealsV3ApiItem
}
var file_PublicAggreDealsV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicAggreDealsV3Api.deals:type_name -> pb.PublicAggreDealsV3ApiItem
