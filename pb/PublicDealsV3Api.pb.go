...
const file_PublicDealsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x16PublicDealsV3Api.proto\x12\x02pb\"`\n" +
	"\x10PublicDealsV3Api\x12.\n" +
	"\x05deals\x18\x01 \x03(\v2\x18.pb.PublicDealsV3ApiItemR\x05deals\x12\x1c\n" +
	...
	"\x1ccom.mxc.push.common.protobufB\x15PublicDealsV3ApiProtoH\x01P\x01Z\x0ecrypt_proto/pbb\x06proto3"
...
var file_PublicDealsV3Api_proto_goTypes = []any{
	(*PublicDealsV3Api)(nil),     // 0: pb.PublicDealsV3Api
	(*PublicDealsV3ApiItem)(nil), // 1: pb.PublicDealsV3ApiItem
}
var file_PublicDealsV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicDealsV3Api.deals:type_name -> pb.PublicDealsV3ApiItem
