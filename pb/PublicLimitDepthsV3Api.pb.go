...
const file_PublicLimitDepthsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1cPublicLimitDepthsV3Api.proto\x12\x02pb\"\xb6\x01\n" +
	"\x16PublicLimitDepthsV3Api\x121\n" +
	"\x04asks\x18\x01 \x03(\v2\x1d.pb.PublicLimitDepthV3ApiItemR\x04asks\x121\n" +
	"\x04bids\x18\x02 \x03(\v2\x1d.pb.PublicLimitDepthV3ApiItemR\x04bids\x12\x1c\n" +
	...
	"\x1ccom.mxc.push.common.protobufB\x1bPublicLimitDepthsV3ApiProtoH\x01P\x01Z\x0ecrypt_proto/pbb\x06proto3"
...
var file_PublicLimitDepthsV3Api_proto_goTypes = []any{
	(*PublicLimitDepthsV3Api)(nil),    // 0: pb.PublicLimitDepthsV3Api
	(*PublicLimitDepthV3ApiItem)(nil), // 1: pb.PublicLimitDepthV3ApiItem
}
var file_PublicLimitDepthsV3Api_proto_depIdxs = []int32{
	1, // 0: pb.PublicLimitDepthsV3Api.asks:type_name -> pb.PublicLimitDepthV3ApiItem
	1, // 1: pb.PublicLimitDepthsV3Api.bids:type_name -> pb.PublicLimitDepthV3ApiItem
